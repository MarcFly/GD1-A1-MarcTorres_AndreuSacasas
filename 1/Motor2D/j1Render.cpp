...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float speed, double angle,float render_scale, bool flip, int pivot_x, int pivot_y) const
{
	bool ret = true;
